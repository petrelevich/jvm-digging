...
public class DogService {
    ...
    private void level1() {
        ...
        var dogById =
                dogRepository
                        .findById(dogCreated.getDogId())
                        .orElseThrow(
                                () ->
                                        new RuntimeException(
                                                "dog not found, DogId: " + dogCreated.getDogId()));
    ...
    private void level2() {
        ...
        var selectedOwner =
                ownerRepository
                        ...
                        .orElseThrow(
                                () ->
                                        new RuntimeException(
                                                "selected owner not found, name: " + ownerName));
        ...
        var ownerReal =
                new Owner(
                        ownerName,
                        "Васильки",
                        Set.of(new Dog("Бобик", null), new Dog("Барбос")),
                        false);

        ownerRepository.save(ownerReal);

        var selectedOwnerReal =
                ownerRepository
                        .findById(ownerName)
                        .orElseThrow(
                                () -> new RuntimeException("owner not found, name: " + ownerName));
    ...
    private void level3() {
        ...
        var guardDog =
                dogRepository
                        .findGuardDogByName(dogName)
                        .orElseThrow(
                                () -> new RuntimeException("guard Dog not found, name:" + dogName));
