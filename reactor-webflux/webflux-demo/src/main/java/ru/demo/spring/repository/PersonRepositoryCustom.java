...
public class PersonRepositoryCustom {
    ...
    public Flux<PersonDto> findAll() {
        return template.getDatabaseClient().inConnectionMany(connection -> Flux.from(
                        connection.createStatement(SQL_ALL).execute())
    ...
    private PersonDto mapper(Readable selectedRecord) {
        ...
        try {
            ...
            return new PersonDto(
                    selectedRecord.get("person_id", String.class),
