...
public class CalculationsVThread {
    private static final Logger logger = LoggerFactory.getLogger(CalculationsVThread.class);
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(CalculationsVThread.class, args);
    }
}
