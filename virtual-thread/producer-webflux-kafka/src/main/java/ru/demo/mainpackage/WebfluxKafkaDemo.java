...
public class WebfluxKafkaDemo {
    private static final Logger logger = LoggerFactory.getLogger(WebfluxKafkaDemo.class);
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(WebfluxKafkaDemo.class, args);
    }
}
