...
public class VirtualThreadKafkaDemo {
    private static final Logger logger = LoggerFactory.getLogger(VirtualThreadKafkaDemo.class);
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(VirtualThreadKafkaDemo.class, args);
    }
}
